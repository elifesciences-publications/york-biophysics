function [x_centre, y_centre, clipping_flag, Ibg_avg, Isp, Idata, bg_noise_std,  mask_pixels, noConvergenceFlag]= ...
    findSpotCentre2(image_data,x_estimate,y_estimate,subarray_halfwidth,inner_radius,sigma_gauss, error_set, clip_override,show_output)
% 
...
while (error1>error_set || k<11) && clipping_flag==0 % at least 10 iterations. Method convergence criterion is error1 (see below)<=0.05 pixels. Stop iterations if clipping flag goes on.
    %
