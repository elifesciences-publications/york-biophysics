function [sdx, sdy, Icent] = fit2DgaussianFixedCenter2(image_data,Ibg_avg, Isp, x_centre, y_centre,subarray_halfwidth, ...
    guess_sigma_Fit, sigmaFit_max, sigmaFit_min, show_output,myfit,options)
